        ...
        <template #header>
            <div class="flex flex-col items-center gap-2">
                <div class="flex items-center justify-center gap-3">
                    <FontAwesomeIcon icon="fa-solid fa-lock" class="h-8 w-8 text-blue-600 dark:text-fuchsia-400 drop-shadow-lg" />
                    <h2 class="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-fuchsia-500 to-cyan-400 dark:from-fuchsia-400 dark:via-blue-400 dark:to-cyan-300 drop-shadow-lg text-center">
                        Cambiar contraseña
                    </h2>
                </div>
