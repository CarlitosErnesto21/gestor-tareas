        ...
        <template #header>
            <div class="flex flex-col gap-2 sm:flex-row sm:justify-between sm:items-center w-full">
                <div class="flex items-center gap-2">
                    <FontAwesomeIcon icon="fa-solid fa-plus" class="text-fuchsia-600 dark:text-blue-400 h-7 w-7 drop-shadow-lg" />
                    <h1 class="text-2xl sm:text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 via-blue-500 to-cyan-400 dark:from-fuchsia-400 dark:via-blue-400 dark:to-cyan-300">Nueva Tarea</h1>
                </div>
